import { resolveHighlights } from "../src/lib/setHighlights/index.ts";
...
const r = await resolveHighlights(tmntProduct, "EN");
...
if (r.cards[0]) console.log("first:", { name: r.cards[0].name, img: r.cards[0].imageUrl });
