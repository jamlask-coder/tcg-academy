...
const PARTIAL: EntityRegistryEntry[] = [
  ...
  },
  {
    ...
    storageKeys: ["tcgacademy_notif_dynamic", "tcgacademy_broadcasts", "tcgacademy_notifications", "tcgacademy_fiscal_notifications", "tcgacademy_admin_notifs_read"],
  ...
  {
    key: "presupuestos",
    description: "Presupuestos / estimaciones fiscales (pre-factura)",
    storageKeys: ["tcgacademy_presupuestos"],
    event: "tcga:presupuestos:updated" as DataHubEventName,
    pii: true,
    retentionMonths: 72,
    adapter: null,
    maturity: "partial",
    category: "fiscal",
    dependsOn: ["users"],
    notes: "Presupuesto != factura: no forma parte de la cadena VeriFactu hasta conversión.",
  },
  {
    key: "userActivity",
