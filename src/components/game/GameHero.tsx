...
// ── Fan layout config ──────────────────────────────────────────────────────────
const FAN_5 = [
  { rotate: -10, x: -118, y: 18, zIndex: 10, floatPhase: 0.1 },
  { rotate: -5, x: -59, y: 8, zIndex: 20, floatPhase: 0.6 },
  { rotate: 0, x: 0, y: 0, zIndex: 30, floatPhase: 0.0 },
  { rotate: 5, x: 59, y: 8, zIndex: 20, floatPhase: 0.8 },
  { rotate: 10, x: 118, y: 18, zIndex: 10, floatPhase: 0.4 },
];
...
function BgPatternOverlay({
  ...
  const style = useMemo((): React.CSSProperties => {
    switch (pattern) {
      case "pokeball":
        return {
          backgroundImage: `radial-gradient(circle, ${color}18 2px, transparent 2px)`,
          backgroundSize: "32px 32px",
        };
      case "runes":
        return {
          backgroundImage: `repeating-linear-gradient(60deg,${color}0A 0,${color}0A 1px,transparent 1px,transparent 20px),repeating-linear-gradient(-60deg,${color}0A 0,${color}0A 1px,transparent 1px,transparent 20px)`,
        };
      case "egyptian":
        return {
          backgroundImage: `repeating-linear-gradient(45deg,${color}08 0,${color}08 1px,transparent 0,transparent 22px),repeating-linear-gradient(-45deg,${color}08 0,${color}08 1px,transparent 0,transparent 22px)`,
        };
      case "waves":
        return {
          backgroundImage: `repeating-linear-gradient(180deg,transparent 0,transparent 24px,${color}0C 24px,${color}0C 26px)`,
        };
      case "hexagons":
        return {
          backgroundImage: `radial-gradient(circle,${color}14 1px,transparent 1px)`,
          backgroundSize: "28px 28px",
        };
      case "sparkles":
        return {
          backgroundImage: `radial-gradient(circle,${color}16 1.5px,transparent 1.5px)`,
          backgroundSize: "24px 24px",
        };
      case "aura":
        return {
          backgroundImage: `repeating-radial-gradient(circle at 50% 50%,transparent 0,transparent 30px,${color}0A 30px,${color}0A 32px)`,
        };
      case "leaves":
        return {
          backgroundImage: `repeating-linear-gradient(30deg,${color}08 0,${color}08 1px,transparent 0,transparent 18px),repeating-linear-gradient(150deg,${color}08 0,${color}08 1px,transparent 0,transparent 18px)`,
        };
      case "grid":
        return {
      ...
      case "diamond":
        return {
          backgroundImage: `repeating-linear-gradient(45deg,${color}0A 0,${color}0A 1px,transparent 0,transparent 20px)`,
        };
      case "circuit":
        return {
...
export function GameHero({ game, config }: Props) {
  ...
  const mobileCards =
    cards.length >= 5 ? [cards[1], cards[2], cards[3]] : cards.slice(0, 3);
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div
          className="absolute bottom-0 -left-20 h-64 w-64 rounded-full blur-3xl"
          style={{ backgroundColor: color, opacity: 0.1 }}
        />
        <div
          className="absolute top-1/3 left-1/2 h-[280px] w-[280px] -translate-x-1/2 -translate-y-1/2 rounded-full blur-3xl"
        ...
        >
          ...
          >
            ...
            <motion.p
              ...
              className="max-w-[200px] text-center text-xs leading-relaxed text-white/55"
            >
              {description}
            </motion.p>
          </motion.div>
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom,transparent,rgba(249,250,251,0.08))",
        }}
        aria-hidden="true"
      />
