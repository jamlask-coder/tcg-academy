        ...
        <div className="mb-6 rounded-2xl border border-gray-200 bg-white p-5">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex min-h-[44px] items-center text-sm font-semibold whitespace-nowrap text-[#2563eb] hover:underline"
            >
              Seguir en GLS →
            </a>
          </div>
