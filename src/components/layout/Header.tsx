...
function MobileTrustBar() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(90deg, #1e40af 0%, #2563eb 50%, #1d4ed8 100%)",
      }}
    >
      <span
  ...
  if (user) {
    return (
      <div className="relative hidden lg:block" ref={menuRef}>
        ...
        >
          <div className="flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-[#2563eb]">
      ...
      <form onSubmit={handleSubmit} className="flex items-stretch">
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="h-full px-4 text-xs font-semibold bg-[#2563eb] text-white hover:bg-[#1d4ed8] transition disabled:opacity-60 whitespace-nowrap border-r border-[#1d4ed8]"
          >
            {loading ? "…" : "Entrar"}
          </button>
          <Link
  ...
  return (
    <header className="border-b border-gray-200 bg-white shadow-sm">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, #1e40af 0%, #2563eb 45%, #1d4ed8 100%)",
        }}
      >
      ...
      <Container className="flex h-16 items-center gap-3">
        ...
        <Link href="/" className="flex flex-shrink-0 items-center gap-2">
          ...
          <span className="hidden text-xl font-bold text-[#2563eb] sm:block">
            TCG Academy
          </span>
        </Link>
        ...
        >
          <form onSubmit={handleDesktopSubmit}>
            <input
              ...
              className="h-8 w-full rounded-xl border-2 border-gray-200 bg-gray-50 pr-8 pl-3 text-xs transition focus:border-[#2563eb] focus:bg-white focus:outline-none"
              autoComplete="off"
            />
            <button
              type="submit"
              className="absolute top-1/2 right-2.5 -translate-y-1/2 text-gray-400 hover:text-[#2563eb]"
              aria-label="Buscar"
            >
              <Search size={14} />
            </button>
