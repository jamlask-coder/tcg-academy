    ...
    <div className="flex flex-wrap justify-center gap-1.5">
      ...
      {hasOverflow && !expanded && (
        <button
          ...
          className="min-h-[32px] rounded-full border-2 border-dashed border-gray-300 px-2.5 py-1 text-xs font-semibold text-gray-500 transition hover:border-gray-400 md:hidden"
        >
