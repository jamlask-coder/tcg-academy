...
export function ProductDeleteModal({
  ...
  return (
    ...
    >
      <div className="animate-in fade-in zoom-in-95 w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
        {/* Header */}
        ...
        <div className="mb-5 flex items-center gap-4 rounded-xl border border-gray-200 bg-gray-50 p-4">
          ...
          <div className="min-w-0">
            <p className="truncate text-sm leading-snug font-semibold text-gray-900">
              {product.name}
            </p>
