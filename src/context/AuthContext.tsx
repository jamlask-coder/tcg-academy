...
// ─── Demo users — ELIMINADOS ────────────────────────────────────────────────
// Modo real 100%: ya no hay cuentas simuladas. Login va contra Supabase vía
// /api/auth (server-mode) o tcgacademy_registered (local-mode dev). Mantenemos
// el símbolo `DEMO_USERS` como mapa permanentemente vacío para no romper los
// callsites existentes (`DEMO_USERS[key]` devuelve undefined → fallthrough).
