          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {PASOS.map(({ n, title, desc }) => (
              <div key={n} className="text-center">
                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#2563eb]">
          ...
          {submitted ? (
            ...
            >
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    className={`h-11 w-full rounded-xl border-2 px-4 text-sm transition focus:outline-none ${errors.ciudad ? "border-red-400" : "border-gray-200 focus:border-[#2563eb]"}`}
                  />
                  {errors.ciudad && (
                    <p className="mt-1 text-xs text-red-500">
                ...
                <div>
                  ...
                  <select
                    ...
                    className={`h-11 w-full rounded-xl border-2 bg-white px-4 text-sm transition focus:outline-none ${errors.presupuesto ? "border-red-400" : "border-gray-200 focus:border-[#2563eb]"}`}
                  >
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#2563eb] py-4 text-lg font-bold text-white transition hover:bg-[#1d4ed8] disabled:opacity-60"
              >
                {isSubmitting ? (
                  "Enviando..."
                ) : (
