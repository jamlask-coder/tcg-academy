...
export default function RegistroPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!checkRateLimit("registro", 5, 60_000)) {
      setServerError("Demasiados intentos. Espera un minuto antes de volver a intentarlo.")
      return
    }
    if (!validate()) return
    setLoading(true)
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {[
                  ...
                  <div key={id}>
                    ...
                    <input
                      ...
                      maxLength={type === "email" ? 254 : type === "tel" ? 20 : 100}
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="sm:col-span-2 grid grid-cols-3 gap-4">
                  <div className="col-span-2">
                    ...
                    <input type="text" maxLength={200} value={form.calle} onChange={set("calle")} placeholder="Nombre de la calle" className={inputClass("calle")} />
                  ...
                  <div>
                    ...
                    <input type="text" maxLength={10} value={form.numero} onChange={set("numero")} placeholder="Nº" className={inputClass("numero")} />
                ...
                <div>
                  ...
                  <input type="text" maxLength={20} value={form.piso} onChange={set("piso")} placeholder="2º B" className={inputClass("piso")} />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-1.5">Codigo postal *</label>
                  <input type="text" maxLength={5} value={form.cp} onChange={set("cp")} placeholder="28001" className={inputClass("cp")} />
                ...
                <div>
                  ...
                  <input type="text" maxLength={100} value={form.ciudad} onChange={set("ciudad")} placeholder="Madrid" className={inputClass("ciudad")} />
                ...
                <div>
                  ...
                  <input type="text" maxLength={100} value={form.provincia} onChange={set("provincia")} placeholder="Madrid" className={inputClass("provincia")} />
                </div>
                <div>
            ...
            <label className="flex items-start gap-2.5 cursor-pointer select-none">
              ...
              <span className="text-sm text-gray-600">
                Acepto los{" "}
                <Link href="/contacto" className="text-[#1a3a5c] hover:underline">terminos y condiciones</Link>
                {" "}y la{" "}
                <Link href="/contacto" className="text-[#1a3a5c] hover:underline">politica de privacidad</Link>
                {" "}*
              </span>
            </label>
