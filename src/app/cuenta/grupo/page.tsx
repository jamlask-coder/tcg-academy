      ...
      <div className="overflow-hidden rounded-2xl border-2 border-[#2563eb] bg-gradient-to-br from-blue-50 to-green-50">
        ...
        <div className="p-5">
          ...
          <div className="flex flex-wrap gap-2">
            {["TÚ", "Ana", "Luis", "María"].map((name) => (
              <div
                key={name}
                className="flex flex-col items-center rounded-xl border-2 border-green-300 bg-green-50 px-3 py-2 text-center"
              >
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <div className="rounded-2xl border border-green-200 bg-green-50 p-4 text-center">
          ...
          <p className="mt-0.5 text-xs font-semibold text-gray-500">Pts del grupo</p>
        </div>
        <div className="rounded-2xl border border-gray-200 bg-white p-4 text-center">
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5">
        <h2 className="mb-4 flex items-center gap-2 font-bold text-gray-900">
          <Users size={18} className="text-[#2563eb]" /> Tu grupo
        </h2>
        <GroupOrganigram
          associations={associations}
          attribution={attribution}
