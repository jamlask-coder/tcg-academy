        ...
        <div className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-gray-100 md:p-12">
          ...
          <Section title="5. Destinatarios de los datos">
            ...
            <ul>
              ...
              <li>
                ...
                facturación cuando sea necesario para el cumplimiento
                tributario.
              </li>
            </ul>
            <p>
          ...
          <Section title="6. Sus derechos">
            ...
            <p>
              ...
              en <span className="text-[#2563eb]">www.aepd.es</span>.
            </p>
          </Section>
...
function Row({
  ...
  if (header) {
    return (
      <div
        className={`${base} border-b border-gray-200 font-semibold text-gray-700`}
      >
        <span>{label}</span>
        <span>{value}</span>
      </div>
