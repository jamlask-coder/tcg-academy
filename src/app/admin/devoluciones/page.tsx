    ...
    <div className="mx-auto max-w-6xl px-4 py-8">
      <header className="mb-6">
        ...
        <p className="mt-1 text-sm text-slate-600">
          Gestión de solicitudes de devolución. El reembolso puede emitirse por
          cualquier medio (transferencia, efectivo, tarjeta, Bizum o mismo medio
          de pago). Reembolsar es irreversible: genera factura rectificativa y
          afecta al Modelo 303.
        </p>
      </header>
