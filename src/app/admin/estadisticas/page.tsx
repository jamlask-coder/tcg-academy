  ...
  return (
    <div>
      ...
      <div className="mb-6 grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white lg:col-span-2">
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-gray-100 px-5 py-4">
            <div>
              <h2 className="font-bold text-gray-900">Visitas por provincia</h2>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-5">
            <h2 className="mb-4 font-bold text-gray-900">Fuentes de tráfico</h2>
      ...
      <div className="mb-6 grid gap-6 lg:grid-cols-2">
        ...
        <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white">
          <div className="border-b border-gray-100 px-5 py-4">
            <h2 className="font-bold text-gray-900">Comunidades autónomas</h2>
            <p className="text-xs text-gray-400">Agrupado por comunidad</p>
          </div>
          <div className="p-5">
            {(() => {
