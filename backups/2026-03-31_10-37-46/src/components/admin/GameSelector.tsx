    ...
    <div>
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="flex items-center gap-2 text-2xl font-bold text-gray-900">
            <LayoutGrid size={22} className="text-[#1a3a5c]" /> Catálogo visual
          </h1>
      ...
      <div className="mb-6">
        <button
          ...
          className="group w-full rounded-2xl border-2 border-dashed border-[#1a3a5c]/30 bg-[#1a3a5c]/5 p-5 text-left transition hover:border-[#1a3a5c]/50 hover:bg-[#1a3a5c]/10"
        >
          <div className="flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#1a3a5c]/10 transition group-hover:scale-105">
              <LayoutGrid size={22} className="text-[#1a3a5c]" />
            </div>
            <div>
              <p className="font-bold text-[#1a3a5c]">Ver todos los juegos</p>
