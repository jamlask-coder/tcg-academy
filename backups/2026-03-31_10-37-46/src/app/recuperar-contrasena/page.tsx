        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
          {submitted ? (
            <div className="py-4 text-center">
              ...
              <h2 className="mb-2 text-lg font-bold text-gray-900">Email enviado</h2>
              ...
              <Link
                href="/login"
                className="inline-flex items-center gap-1.5 text-sm font-semibold text-[#1a3a5c] hover:underline"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <p className="text-center text-sm text-gray-500">
                <Link
                  href="/login"
                  className="inline-flex items-center gap-1 text-[#1a3a5c] hover:underline"
                >
