    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
        <div className="w-full max-w-sm rounded-2xl bg-white p-8 text-center shadow-2xl">
          ...
          <button
            onClick={onClose}
            className="w-full rounded-xl bg-[#1a3a5c] py-3 font-bold text-white transition hover:bg-[#15304d]"
          >
            Aceptar
          </button>
        </div>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
        ...
        <p className="mb-4 text-sm text-gray-500">
          Saldo disponible:{" "}
          <strong className="text-base text-[#1a3a5c]">{balance} puntos</strong>
        </p>
        ...
        <button
          ...
          disabled={!selected}
          className="w-full rounded-xl bg-[#1a3a5c] py-3.5 text-sm font-bold text-white transition hover:bg-[#15304d] disabled:opacity-40"
        >
            ...
            <tbody>
              {POINTS_REDEMPTION_TABLE.map((row) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-right text-base font-bold text-[#1a3a5c]">
                    {row.euros.toFixed(2)}€
                  </td>
                </tr>
              ))}
