    ...
    <div>
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
        ...
        {unreadCount > 0 && (
          <button
            onClick={markAllRead}
            className="flex min-h-[44px] items-center gap-1.5 rounded-xl border border-[#1a3a5c]/20 px-4 py-2.5 text-sm font-semibold text-[#1a3a5c] transition hover:bg-blue-50"
          >
