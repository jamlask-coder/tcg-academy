      ...
      <div className="mx-auto max-w-3xl px-6">
        ...
        <div className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-gray-100 md:p-12">
          ...
          <Section title="2. Objeto y ámbito de aplicación">
            <p>
              Las presentes condiciones generales regulan el acceso, navegación y
              uso del sitio web <strong>TCG Academy</strong>, así como las
          ...
          <Section title="5. Envíos y plazos de entrega">
            <p>
              ...
              {SITE_CONFIG.dispatchHours} horas hábiles desde la confirmación del
              pago. El envío es gratuito para pedidos superiores a{" "}
            ...
            <p>
              ...
              causas ajenas a TCG Academy (incidencias del transportista, festivos,
              etc.).
            </p>
          </Section>
          ...
          <Section title="9. Legislación aplicable y jurisdicción">
            <p>
              ...
              previsto en la normativa de defensa de los consumidores y usuarios.
            </p>
            <p>
          ...
          <Section title="10. Modificaciones">
            <p>
              ...
              desde su publicación en el sitio web. El uso continuado del sitio
              tras la publicación implica la aceptación de las nuevas condiciones.
            </p>
          </Section>
