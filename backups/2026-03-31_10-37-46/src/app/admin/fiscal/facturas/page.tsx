                ...
                {filtered.map((inv) => {
                  ...
                  return (
                    <>
                      ...
                      >
                        <td
                          className="cursor-pointer px-4 py-3 font-mono text-xs font-bold text-[#1a3a5c]"
                          onClick={() =>
                        ...
                        <td className="px-4 py-3 text-center">
                          <div className="flex items-center justify-center gap-2">
                            ...
                            <button
                              ...
                              className="rounded border border-[#1a3a5c]/20 px-2 py-1 text-xs font-semibold text-[#1a3a5c] hover:bg-blue-50"
                            >
                              CSV
                            </button>
                          </div>
