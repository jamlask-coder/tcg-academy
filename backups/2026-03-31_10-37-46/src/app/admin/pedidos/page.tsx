...
const EMAIL_TEMPLATES = [
  {
    ...
    body: "Hola,\n\nHemos registrado tu pedido y lo estamos preparando. En breve recibirás el número de seguimiento.\n\nGracias por confiar en TCG Academy.",
  },
  {
    id: "enviado",
...
function Toast({ message, onClose }: { message: string; onClose: () => void }) {
  return (
    <div className="animate-fade-in fixed right-6 bottom-6 z-50 flex max-w-sm items-center gap-3 rounded-2xl bg-[#1a3a5c] px-5 py-3 text-white shadow-xl">
      ...
      >
        ...
        <div className="space-y-4 px-6 py-4">
            ...
            <div className="flex flex-wrap gap-1.5">
              {EMAIL_TEMPLATES.map((t) => (
                <button
                  ...
                  className={`rounded-lg border px-2.5 py-1 text-xs transition ${tplId === t.id ? "border-[#1a3a5c] bg-[#1a3a5c] text-white" : "border-gray-200 text-gray-600 hover:bg-gray-50"}`}
                >
                  {t.label}
                </button>
              ))}
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm focus:border-[#1a3a5c] focus:outline-none"
            />
          </div>
          <div>
            <label className="mb-1 block text-xs font-semibold text-gray-500">
            ...
            <textarea
              ...
              rows={5}
              className="w-full resize-none rounded-lg border border-gray-200 px-3 py-2 text-sm focus:border-[#1a3a5c] focus:outline-none"
            />
          </div>
        </div>
        <div className="flex justify-end gap-3 border-t border-gray-100 px-6 py-4">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-lg bg-[#1a3a5c] px-4 py-2 text-sm font-semibold text-white hover:bg-[#2d6a9f] disabled:opacity-50"
          >
      ...
      <div className="flex overflow-x-auto border-b border-gray-100 px-4">
        {tabs.map(({ id, label, icon: Icon }) => (
          <button
            ...
            className={`flex items-center gap-1.5 border-b-2 px-3 py-3 text-xs font-semibold whitespace-nowrap transition ${tab === id ? "border-[#1a3a5c] text-[#1a3a5c]" : "border-transparent text-gray-500 hover:text-gray-700"} ${id === "incidencia" ? "text-red-600" : ""}`}
          >
            <Icon size={13} /> {label}
        ...
        <div className="ml-auto flex items-center gap-2 py-2 pl-4">
          <button
            ...
            className="flex items-center gap-1 rounded-lg px-2 py-1.5 text-xs text-gray-500 transition hover:bg-gray-100 hover:text-[#1a3a5c]"
          >
            ...
            <div className="rounded-xl border border-gray-200 p-4">
              {order.adminStatus === "pagado" && (
                <div className="flex items-center gap-3">
                  <Package size={16} className="flex-shrink-0 text-amber-500" />
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 rounded-xl bg-amber-500 px-4 py-2 text-sm font-bold whitespace-nowrap text-white transition hover:bg-amber-600"
                  >
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`h-10 w-full rounded-xl border-2 px-3 font-mono text-sm transition focus:outline-none ${trackingError ? "border-red-400" : "border-gray-200 focus:border-[#1a3a5c]"}`}
                    />
                    {trackingError && (
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 rounded-xl bg-[#1a3a5c] px-4 py-2.5 text-sm font-bold text-white transition hover:bg-[#2d6a9f]"
                  >
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              {order.incident.messages.map((m, i) => (
                ...
                >
                  <div
                    className={`flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full text-xs font-bold ${m.from === "admin" ? "bg-[#1a3a5c] text-white" : "bg-gray-200 text-gray-600"}`}
                  >
            ...
            {order.incident.status !== "resuelta" && (
              <div className="space-y-2">
                <textarea
                  ...
                  rows={3}
                  className="w-full resize-none rounded-xl border border-gray-200 px-3 py-2 text-sm focus:border-[#1a3a5c] focus:outline-none"
                />
        ...
        {tab === "notas" && (
          <div className="space-y-3">
            ...
            <textarea
              ...
              rows={5}
              className="w-full resize-none rounded-xl border border-gray-200 px-3 py-2.5 text-sm focus:border-[#1a3a5c] focus:outline-none"
            />
            <button
              onClick={() => onSaveNotes(order.id, notes)}
              className="flex items-center gap-1.5 rounded-xl bg-[#1a3a5c] px-4 py-2 text-sm font-bold text-white transition hover:bg-[#2d6a9f]"
            >
      ...
      <div className="mb-4 flex flex-wrap items-center gap-2">
        <div className="relative min-w-[180px] flex-1">
          ...
          <input
            ...
            className="h-9 w-full rounded-xl border border-gray-200 pr-3 pl-8 text-sm focus:border-[#1a3a5c] focus:outline-none"
          />
        </div>
        <select
          value={statusFilter}
          ...
          className="h-9 rounded-xl border border-gray-200 bg-white px-3 text-sm focus:border-[#1a3a5c] focus:outline-none"
        >
              ...
              {filtered.map((order) => {
                ...
                return (
                  <>
                    <tr
                      key={order.id}
                      className={`cursor-pointer transition hover:bg-gray-50/70 ${isOpen ? "bg-blue-50/30" : ""} ${urgent ? "border-l-4 border-l-amber-400" : ""}`}
