...
export function HoloCard({
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: fanY - (compact ? 12 : 20), rotate: fanRotate * 0.25, scale: compact ? 1.08 : 1.12, zIndex: 20 }}
      transition={{
      ...
      style={{ position: "absolute", left: "50%", top: "50%", marginLeft: -(width / 2), marginTop: -(height / 2), zIndex, transformOrigin: "bottom center" }}
    >
            ...
            {tilt.active && (
              <div
                ...
                style={{
                  position: "absolute",
                  inset: 0,
                  background: `radial-gradient(circle at ${tilt.sx}% ${tilt.sy}%, rgba(255,255,255,0.5) 0%, rgba(255,255,255,0.15) 35%, transparent 65%)`,
            ...
            {tilt.active && (
              <div
                ...
                style={{
                  position: "absolute",
                  inset: 0,
                  background: `linear-gradient(${tilt.sx * 3.6}deg,
                    rgba(255,0,128,0.14) 0%,
                    rgba(255,140,0,0.13) 18%,
                    rgba(255,230,0,0.11) 36%,
                    rgba(0,220,100,0.11) 54%,
                    rgba(0,120,255,0.13) 72%,
                    rgba(130,0,255,0.13) 90%,
                    rgba(255,0,128,0.11) 100%)`,
