...
const inputCls =
  "w-full rounded-xl border-2 border-gray-200 px-3 py-2 text-sm transition focus:border-[#1a3a5c] focus:outline-none";
    ...
    >
      <div className="w-full max-w-2xl rounded-2xl bg-white shadow-2xl">
                ...
                {tagsStr
                  ...
                  .map((tag) => (
                    <span
                      ...
                      style={{ backgroundColor: gameCfg?.color ?? "#1a3a5c" }}
                    >
                      {tag}
                    </span>
                  ))}
        ...
        <div className="flex gap-3 border-t border-gray-100 px-6 py-4">
          ...
          <button
            onClick={handleSave}
            className="flex-1 flex items-center justify-center gap-2 rounded-xl bg-[#1a3a5c] px-4 py-2.5 text-sm font-bold text-white transition hover:bg-[#15304d]"
          >
            <Save size={15} />
