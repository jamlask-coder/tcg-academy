      ...
      <div className="flex flex-1 flex-col items-center justify-center bg-white px-6 py-12">
        ...
        >
          <div className="mb-8">
            ...
            <p className="mt-1 text-gray-500">Accede a tu cuenta de TCG Academy</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  maxLength={254}
                  className="h-11 w-full rounded-xl border-2 border-gray-200 pr-4 pl-10 text-sm transition-all focus:border-[#1a3a5c] focus:outline-none focus:ring-2 focus:ring-[#1a3a5c]/10"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  maxLength={128}
                  className="h-11 w-full rounded-xl border-2 border-gray-200 pr-10 pl-10 text-sm transition-all focus:border-[#1a3a5c] focus:outline-none focus:ring-2 focus:ring-[#1a3a5c]/10"
                />
                <button
                  type="button"
          ...
          <Link
            href="/registro"
            className="flex h-11 w-full items-center justify-center rounded-xl border-2 border-gray-200 text-sm font-semibold text-gray-700 transition hover:border-[#1a3a5c] hover:text-[#1a3a5c]"
          >
            Crear cuenta nueva
          </Link>
