    ...
    <div className="mx-auto max-w-[1400px] px-6 py-8">
      ...
      <div className="mb-6">
        <CategoryTags
          ...
          color={
            selectedGame ? (GAME_CONFIG[selectedGame]?.color ?? "#1a3a5c") : "#1a3a5c"
          }
        />
      </div>
      ...
      <div className="mb-6 flex gap-3">
        ...
        <div className="relative">
          <select
            ...
            className="h-11 cursor-pointer appearance-none rounded-xl border-2 border-gray-200 bg-white pr-9 pl-4 text-sm font-medium text-gray-700 transition focus:border-[#1a3a5c] focus:outline-none"
          >
            {SORT_OPTIONS.map((o) => (
          ...
          {hasMore && (
            <div className="mt-10 text-center">
              <button
                ...
                className="rounded-xl border-2 border-[#1a3a5c] bg-white px-10 py-3.5 font-bold text-[#1a3a5c] transition hover:bg-[#1a3a5c] hover:text-white"
              >
