...
> = {
  b2b: { label: "Distribuidor B2B", icon: Building2, color: "#1a3a5c" },
        ...
        <div className="flex flex-shrink-0 items-center gap-1">
          {email && (
            <a
              ...
              className="flex min-h-[36px] min-w-[36px] items-center justify-center rounded-lg p-2 text-gray-400 transition hover:bg-gray-100 hover:text-[#1a3a5c]"
            >
              <Mail size={15} />
            </a>
          )}
