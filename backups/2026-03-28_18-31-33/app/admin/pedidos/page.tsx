...
const STATUS_OPTIONS: OrderStatus[] = ["pedido", "enviado", "entregado", "incidencia"]
...
const STATUS_COLORS: Record<OrderStatus, string> = {
  ...
  incidencia: "bg-red-100 text-red-600 border-red-200",
}
                    ...
                    <tr key={`${order.id}-expanded`}>
                      <td colSpan={6} className="px-4 pb-4 bg-blue-50/40">
                        <div className="pt-3 space-y-3">
                          ...
                          {/* Tracking + partial qty when pedido */}
                          {order.status === "pedido" && (
