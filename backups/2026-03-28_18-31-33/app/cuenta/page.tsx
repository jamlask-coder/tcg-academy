        ...
        <div className="mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-5">
              ...
              {(b2bStats?.monthlyData.some((d) => d.gasto > 0) || b2bStats === null) ? (
                <ResponsiveContainer width="100%" height={160}>
                  <AreaChart
                    data={b2bStats?.monthlyData ?? MONTH_LABELS.map((m) => ({ month: m, gasto: 0 }))}
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-5">
              ...
              {b2bStats?.gameData && b2bStats.gameData.length > 0 ? (
                <ResponsiveContainer width="100%" height={160}>
                  <BarChart
                    layout="vertical"
                    data={b2bStats.gameData}
