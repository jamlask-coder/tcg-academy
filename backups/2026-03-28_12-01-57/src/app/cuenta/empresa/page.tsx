  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-500 text-sm mt-1">Informacion comercial y fiscal de tu empresa</p>
      </div>
      ...
      <form onSubmit={handleSave} className="bg-white border border-gray-200 rounded-2xl p-6 space-y-5">
        <div className="grid sm:grid-cols-2 gap-4">
          {[
            ...
            ["direccionFiscal", "Direccion fiscal *", "Calle Mayor 1, 28001 Madrid"],
            ["personaContacto", "Persona de contacto *", "Nombre Apellido"],
            ["telefonoEmpresa", "Telefono empresa", "+34 910 000 000"],
            ["emailFacturacion", "Email de facturacion *", "facturas@empresa.com"],
          ].map(([key, label, placeholder]) => (
            <div key={key} className={key === "direccionFiscal" ? "sm:col-span-2" : ""}>
