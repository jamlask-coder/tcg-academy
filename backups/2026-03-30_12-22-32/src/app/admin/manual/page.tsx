            ...
            <nav className="divide-y divide-gray-100">
              {TOC.map(({ id, title }) => (
                <a
                  key={id}
                  href={`#${id}`}
                  className="flex min-h-[44px] items-center gap-2 px-4 py-3 text-sm text-gray-700 transition hover:bg-gray-50 hover:text-[#1a3a5c]"
                >
                  <ChevronRight
                    size={12}
            ...
            >
              ...
              <div className="space-y-4">
                {content.map(({ heading, text }, i) => (
                  <div key={i}>
                    {heading && (
                      <h3 className="mb-1 text-sm font-bold text-[#1a3a5c]">
                        {heading}
                      </h3>
                    )}
