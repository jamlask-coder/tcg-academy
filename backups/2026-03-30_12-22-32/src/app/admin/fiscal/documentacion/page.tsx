...
function Section({
  ...
  return (
    <section className="mb-8">
      <h2 className="mb-3 text-xl font-bold text-[#1a3a5c]">{title}</h2>
  ...
  return (
    <div className="border-b border-gray-100 last:border-0">
      <button
        ...
        className="flex w-full items-center justify-between py-4 text-left text-sm font-semibold text-gray-800 hover:text-[#1a3a5c]"
      >
  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-3xl">
        ...
        {/* FAQ */}
        <div className="mb-6 rounded-2xl border border-gray-200 bg-white p-8">
          <h2 className="mb-4 text-xl font-bold text-[#1a3a5c]">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-8">
          <h2 className="mb-3 text-xl font-bold text-[#1a3a5c]">
          ...
          <p className="mt-3 text-sm font-semibold text-[#1a3a5c]">
