...
export default function AdminCuponesPage() {
  ...
  return (
    <div>
      ...
      {/* Create form */}
      {showForm && (
        <div className="mb-6 rounded-2xl border-2 border-[#1a3a5c]/20 bg-white p-6">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`h-10 flex-1 rounded-xl border-2 text-sm font-bold transition ${form.discountType === "percent" ? "border-[#1a3a5c] bg-[#1a3a5c] text-white" : "border-gray-200 text-gray-600"}`}
                >
                  % Porcentaje
                </button>
                <button
                  ...
                  className={`h-10 flex-1 rounded-xl border-2 text-sm font-bold transition ${form.discountType === "fixed" ? "border-[#1a3a5c] bg-[#1a3a5c] text-white" : "border-gray-200 text-gray-600"}`}
                >
                  € Fijo
                </button>
              </div>
            ...
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div className="min-w-0 flex-1">
                <div className="mb-1 flex flex-wrap items-center gap-2">
                  <span className="font-mono text-base font-bold tracking-wider text-[#1a3a5c]">
                    {coupon.code}
                  </span>
                  <span
