...
const SOLUTIONS = [
  {
    ...
    href: "/mayoristas/b2b",
    color: "#1a3a5c",
    gradient: "from-[#0f172a] to-[#1a3a5c]",
  },
  {
    icon: Store,
...
const TIERS = [
  ...
  { name: "Platino", range: "+10.000 €/mes", discount: "30%", color: "#7c3aed" },
];
      ...
      <section className="relative overflow-hidden bg-[#0f172a] text-white">
        ...
        <div className="relative mx-auto max-w-[1180px] px-6 py-24 md:py-32">
          ...
          <p className="mb-10 max-w-2xl text-lg leading-relaxed text-slate-300 md:text-xl">
            ...
            catálogo TCG de España a tu alcance, con soporte dedicado y envío
            en 24h.
          </p>
      ...
      <section className="bg-[#0f172a] py-20 text-white">
        <div className="mx-auto max-w-[1180px] px-6 text-center">
          ...
          <p className="mx-auto mb-10 max-w-xl text-slate-400">
            Solicita tu cuenta B2B hoy. Activación en 24-48h tras verificación de
            datos.
          </p>
