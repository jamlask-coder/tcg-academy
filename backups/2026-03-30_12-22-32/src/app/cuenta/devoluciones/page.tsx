  ...
  if (submitted) {
    return (
      <div className="py-6 text-center">
        ...
        <button
          onClick={onClose}
          className="rounded-xl bg-[#1a3a5c] px-6 py-3 text-sm font-bold text-white"
        >
          Cerrar
        </button>
      </div>
      ...
      <div className="mb-6 flex items-center gap-2">
        {[1, 2, 3].map((s) => (
          <div key={s} className="flex flex-1 items-center gap-2">
            ...
            {s < 3 && (
              <div
                className={`mx-1 h-0.5 flex-1 ${step > s ? "bg-[#1a3a5c]" : "bg-gray-200"}`}
              />
            )}
          </div>
        ))}
          ...
          {deliveredOrders.length === 0 ? (
            ...
            deliveredOrders.map((order) => (
              <button
                ...
                className="flex w-full items-center justify-between rounded-xl border-2 p-4 text-left transition hover:border-[#1a3a5c] hover:bg-blue-50/30"
              >
                <div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <select
              ...
              className="h-11 w-full rounded-xl border-2 border-gray-200 bg-white px-4 text-sm focus:border-[#1a3a5c] focus:outline-none"
            >
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full resize-none rounded-xl border-2 border-gray-200 px-4 py-3 text-sm focus:border-[#1a3a5c] focus:outline-none"
            />
          </div>
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 rounded-xl bg-[#1a3a5c] py-3 text-sm font-bold text-white transition hover:bg-[#15304d] disabled:opacity-40"
            >
              Continuar
            </button>
          </div>
      ...
      {step === 3 && (
        <div className="space-y-4">
          <div>
            ...
            <div className="cursor-pointer rounded-xl border-2 border-dashed border-gray-200 p-8 text-center transition hover:border-[#1a3a5c]">
    ...
    <div>
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
        ...
        <button
          ...
          className="flex min-h-[44px] items-center gap-2 rounded-xl bg-[#1a3a5c] px-4 py-2.5 text-sm font-bold text-white transition hover:bg-[#15304d]"
        >
