...
// Order: Magic → Pokemon → One Piece → Riftbound → Yu-Gi-Oh → Lorcana → Dragon Ball → Naruto Mythos → Topps
// Index 0-5: always visible at lg+
// Index 6-8: visible at xl+ directly, at lg via overflow "+" button
        ...
        items: [
          {
            ...
            href: "/pokemon?cat=booster-box",
          },
          {
            label: "Sobres sueltos (Booster Packs)",
            href: "/pokemon?cat=sobres",
          },
    ...
    columns: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            label: "Cartas manga / alternate art",
            href: "/one-piece?cat=alternate-art",
          },
    ...
    columns: [
      {
        title: "Producto Sellado",
        items: [
          { label: "Booster Boxes", href: "/yugioh?cat=booster-box" },
          { label: "Sobres sueltos", href: "/yugioh?cat=sobres" },
          { label: "Tins de colección", href: "/yugioh?cat=tins" },
          { label: "Structure Decks", href: "/yugioh?cat=structure-deck" },
          { label: "Starter Decks", href: "/yugioh?cat=starter" },
        ],
      },
      {
        title: "Cartas",
        items: [
          { label: "Singles", href: "/yugioh?cat=singles" },
          {
            label: "Secret / Ultimate Rare",
            href: "/yugioh?cat=rares",
          },
          { label: "Lotes y colecciones", href: "/yugioh?cat=lotes" },
          { label: "Cartas promo", href: "/yugioh?cat=promo" },
        ],
      },
      {
        title: "Accesorios",
        items: [
          { label: "Fundas (sleeves)", href: "/yugioh?cat=sleeves" },
          { label: "Playmats", href: "/yugioh?cat=playmats" },
          { label: "Deck boxes", href: "/yugioh?cat=deckboxes" },
          { label: "Carpetas", href: "/yugioh?cat=carpetas" },
        ],
      },
    ],
  },
    ...
    columns: [
      {
        title: "Producto Sellado",
        items: [
          { label: "Booster Boxes", href: "/lorcana?cat=booster-box" },
          { label: "Sobres sueltos", href: "/lorcana?cat=sobres" },
          { label: "Starter Decks", href: "/lorcana?cat=starter" },
          { label: "Gift Sets", href: "/lorcana?cat=gift-sets" },
        ],
      },
      {
        title: "Cartas y Accesorios",
        items: [
          { label: "Singles", href: "/lorcana?cat=singles" },
          { label: "Cartas Enchanted", href: "/lorcana?cat=enchanted" },
          { label: "Fundas (sleeves)", href: "/lorcana?cat=sleeves" },
          { label: "Playmats", href: "/lorcana?cat=playmats" },
          { label: "Deck boxes", href: "/lorcana?cat=deckboxes" },
        ],
      },
    ],
  },
    ...
    columns: [
      {
        title: "Producto Sellado",
        items: [
          { label: "Booster Boxes", href: "/dragon-ball?cat=booster-box" },
          { label: "Sobres sueltos", href: "/dragon-ball?cat=sobres" },
          { label: "Starter Decks", href: "/dragon-ball?cat=starter" },
          {
            label: "Special Anniversary",
            href: "/dragon-ball?cat=aniversario",
          },
        ],
      },
      {
        title: "Cartas y Accesorios",
        items: [
          { label: "Singles", href: "/dragon-ball?cat=singles" },
          { label: "Cartas especiales", href: "/dragon-ball?cat=especiales" },
          { label: "Fundas (sleeves)", href: "/dragon-ball?cat=sleeves" },
          { label: "Playmats", href: "/dragon-ball?cat=playmats" },
        ],
      },
    ],
  },
    ...
    columns: [
      {
        title: "Producto Sellado",
        items: [
          { label: "Booster Boxes", href: "/naruto?cat=booster-box" },
          { label: "Sobres sueltos", href: "/naruto?cat=sobres" },
          { label: "Starter Decks", href: "/naruto?cat=starter" },
        ],
      },
      {
        title: "Cartas y Accesorios",
        items: [
          { label: "Singles", href: "/naruto?cat=singles" },
          { label: "Cartas especiales", href: "/naruto?cat=especiales" },
          { label: "Fundas (sleeves)", href: "/naruto?cat=sleeves" },
          { label: "Playmats", href: "/naruto?cat=playmats" },
        ],
      },
    ],
  },
