  ...
  return (
    <div>
      ...
      <section className="relative flex min-h-[500px] items-center overflow-hidden bg-[#0f172a] text-white md:min-h-[580px]">
        ...
        <div className="absolute inset-0" style={{ background: "linear-gradient(to right, #0a0f1a 0%, #1e3a8a 55%, #2563eb 100%)" }} />
        {/* Ambient glows */}
        ...
        {/* Shield — absolute, behind all content, centered between Riftbound and Topps (~80% from left) */}
        <div
          className="pointer-events-none absolute hidden xl:block"
          style={{ left: "74%", top: "50%", transform: "translate(-50%, -50%)", zIndex: 0 }}
        >
          ...
          <img
            ...
            style={{
              width: 520,
              opacity: 0.38,
              filter: "drop-shadow(0 0 90px rgba(147,197,253,0.55)) drop-shadow(0 0 30px rgba(255,255,255,0.2))",
              animation: "heroLogoFloat 9s ease-in-out infinite",
            }}
          />
        </div>

        <div className="relative z-10 mx-auto w-full max-w-[1400px] px-6 py-16 md:py-24">
          ...
          <div className="hidden xl:flex flex-col flex-shrink-0" style={{ width: 360, alignSelf: "stretch", justifyContent: "center" }}>

            {/* Stores timeline — shifted down so Madrid starts where Barcelona was */}
            <div className="relative pl-10" style={{ paddingTop: 70 }}>
              ...
              <div style={{
                ...
                bottom: 6,
                width: 1,
                background: "linear-gradient(to bottom, transparent 0%, rgba(147,197,253,0.7) 20%, rgba(147,197,253,0.7) 80%, transparent 100%)",
              }} />
              ...
              {[
                ...
                >
                  ...
                  {/* Text */}
                  <div>
                    <div className="group-hover:text-amber-300 transition-colors duration-200" style={{
                      fontSize: 11,
                      fontWeight: 600,
                    ...
                    <div style={{ fontSize: 26, fontWeight: 800, letterSpacing: "-0.01em" }}>
                      <span className="text-white group-hover:text-amber-300 transition-colors duration-200">{city}</span>
                    </div>
                  </div>

                  <ArrowRight
                    size={15}
                    className="ml-2 opacity-0 group-hover:opacity-100 group-hover:text-amber-300 transition-all duration-200"
                  />
                </Link>
              ))}
            </div>
      ...
      {/* B2B BANNER */}
      <section className="bg-gradient-to-r from-[#2563eb] to-[#3b82f6] py-16">
        <div className="mx-auto flex max-w-[1400px] flex-col items-center justify-between gap-8 px-6 md:flex-row">
          <div>
            ...
            <p className="max-w-lg text-blue-200">
              ...
              volumen hasta el 30%. Contacto directo y personalizado con
              nuestro equipo.
            </p>
          </div>
