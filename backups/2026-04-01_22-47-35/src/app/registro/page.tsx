            ...
            <div className="space-y-3">
              <label className="flex cursor-pointer items-start gap-2.5 select-none">
                ...
                <span className="text-sm text-gray-600">
                  ...
                  <Link href="/terminos" target="_blank" className="font-medium text-[#2563eb] hover:underline">
                    términos y condiciones
                  </Link>{" "}
                  y la{" "}
                  <Link href="/privacidad" target="_blank" className="font-medium text-[#2563eb] hover:underline">
