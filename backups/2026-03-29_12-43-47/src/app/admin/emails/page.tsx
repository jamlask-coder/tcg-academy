          ...
          <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden">
            ...
            <div className="divide-y divide-gray-100">
              {templates.map((t) => (
                ...
                >
                  <p
                    className={`text-sm font-semibold truncate ${selected.id === t.id ? "text-[#1a3a5c]" : "text-gray-800"}`}
                  >
                    {t.name}
                  </p>
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {MOCK_LOG.map((entry) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-gray-700 text-xs hidden sm:table-cell">
                          {entry.to}
                        </td>
                        ...
                        <td className="px-4 py-3 text-center">
                          <span
                            className={`px-2.5 py-1 rounded-full text-xs font-bold ${STATUS_COLORS[entry.status]}`}
                          >
                            {entry.status}
                          </span>
                        </td>
