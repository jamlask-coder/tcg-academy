              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-100 text-xs text-gray-500 uppercase tracking-wider">
                    ...
                    <th className="text-center px-3 py-3 font-semibold hidden sm:table-cell">
                      Rol
                    </th>
                  ...
                  {filtered.map((user) => (
                    ...
                    >
                      ...
                      <td className="px-3 py-3 text-center hidden sm:table-cell">
                        <span
                          className={`px-2.5 py-1 rounded-full text-xs font-bold capitalize ${ROLE_COLORS[user.role]}`}
                        >
                          {user.role}
                        </span>
                      </td>
                      <td className="px-3 py-3 text-right font-medium text-gray-700 hidden md:table-cell">
                        {user.totalOrders}
                      </td>
