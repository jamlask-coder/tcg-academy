    ...
    <div className="h-full flex flex-col">
      ...
      <div className="bg-[#1a3a5c] rounded-2xl p-4 mb-4 text-white flex-shrink-0">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[10px] bg-amber-400 text-[#1a3a5c] font-black px-2 py-0.5 rounded-full uppercase">
            Admin
          </span>
        </div>
      </div>
                  ...
                  >
                    <span className="flex items-center gap-3">
                      ...
                      {href === "/admin/mensajes" && unreadMsgs > 0 && (
                        <span className="ml-auto bg-blue-500 text-white text-[9px] font-bold px-1.5 py-0.5 rounded-full leading-none">
                          {unreadMsgs}
                        </span>
                      )}
                    </span>
...
function Breadcrumb({ pathname }: { pathname: string }) {
  ...
  return (
    <nav className="flex items-center gap-1.5 text-sm text-gray-500 mb-4">
      <Link href="/admin" className="hover:text-[#1a3a5c] transition">
        Admin
      </Link>
