        ...
        <div className="max-w-[1180px] mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {TIERS.map((tier) => (
              <div
                key={tier.name}
                className="bg-white border-2 rounded-2xl p-6 text-center hover:shadow-lg transition"
        ...
        <div className="max-w-2xl mx-auto">
          ...
          {submitted ? (
            ...
            >
              ...
              <button
                type="submit"
                className="w-full bg-[#1a3a5c] text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2 hover:bg-[#15304d] transition text-base"
              >
