...
export default function AdminCatalogoPage() {
  ...
  const [deleteProduct, setDeleteProduct] = useState<LocalProduct | null>(null);
  ...
  const activeFiltersCount = [filterNoStock, filterDiscount, filterNew].filter(
    Boolean,
  ).length;
        ...
        <div>
          ...
          <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex items-center gap-1.5 rounded-xl border border-gray-200 px-3 py-2 text-sm font-semibold text-gray-600 transition hover:border-[#2563eb] hover:text-[#2563eb]"
              >
          ...
          <div className="mb-4 flex flex-wrap gap-3">
            ...
            <div className="relative min-w-0 flex-1">
              ...
              <input
                ...
                className="h-10 w-full rounded-xl border-2 border-gray-200 pr-8 pl-9 text-sm transition focus:border-[#2563eb] focus:outline-none"
              />
              {search && (
                <button
                  onClick={() => setSearch("")}
            ...
            <div className="relative">
              <select
                ...
                className="h-10 cursor-pointer appearance-none rounded-xl border-2 border-gray-200 bg-white pr-8 pl-3 text-sm font-medium text-gray-700 transition focus:border-[#2563eb] focus:outline-none"
              >
            ...
            >
              ...
              {activeFiltersCount > 0 && (
                <span className="ml-0.5 flex h-4 w-4 items-center justify-center rounded-full bg-white text-[10px] font-black text-[#2563eb]">
                  {activeFiltersCount}
                </span>
              )}
            </button>
          ...
          {displayProducts.length === 0 ? (
            <div className="rounded-2xl border-2 border-dashed border-gray-200 py-20 text-center">
              ...
              <button
                onClick={() => handleAddProduct(selectedGame ?? undefined)}
                className="mx-auto mt-4 flex items-center gap-1.5 rounded-xl bg-[#2563eb] px-5 py-2.5 text-sm font-bold text-white transition hover:bg-[#1d4ed8]"
              >
