      ...
      <div className="mb-6 grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5">
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="h-11 w-24 rounded-xl border-2 border-gray-200 px-3 text-center text-xl font-bold focus:border-[#1a3a5c] focus:outline-none"
                />
            ...
            <button
              ...
              className="flex min-h-[44px] items-center gap-2 rounded-xl bg-[#1a3a5c] px-5 py-2.5 text-sm font-bold text-white transition hover:bg-[#15304d]"
            >
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5">
              ...
              <div key={i} className="flex items-center gap-3">
                <div className="flex flex-1 items-center gap-1.5">
                  ...
                  <input
                    ...
                    className="h-9 w-20 rounded-lg border border-gray-200 px-2 text-center text-sm focus:border-[#1a3a5c] focus:outline-none"
                  />
          ...
          <button
            ...
            className="mt-4 flex min-h-[44px] items-center gap-2 rounded-xl bg-[#1a3a5c] px-4 py-2.5 text-sm font-bold text-white transition hover:bg-[#15304d]"
          >
          ...
          <div className="space-y-3">
            <div>
              ...
              <select
                ...
                className="h-11 w-full rounded-xl border-2 border-gray-200 bg-white px-3 text-sm focus:border-[#1a3a5c] focus:outline-none"
              >
            ...
            <div>
              ...
              <input
                ...
                placeholder="Ej: 50"
                className="h-11 w-full rounded-xl border-2 border-gray-200 px-3 text-sm focus:border-[#1a3a5c] focus:outline-none"
              />
            </div>
            <button
              onClick={() => {
