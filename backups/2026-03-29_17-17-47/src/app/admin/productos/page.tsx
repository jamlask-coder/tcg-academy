...
export default function AdminProductosPage() {
  ...
  const inputCls =
    "w-24 h-8 px-2 border border-gray-200 rounded-lg text-sm text-right focus:outline-none focus:border-[#1a3a5c] transition";
          ...
          >
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 rounded-xl bg-[#1a3a5c] py-3 text-sm font-bold text-white transition hover:bg-[#15304d]"
              >
                Confirmar y aplicar
              </button>
            </div>
      ...
      <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex min-h-[44px] items-center gap-2 rounded-xl bg-[#1a3a5c] px-4 py-2.5 text-sm font-bold text-white transition hover:bg-[#15304d] disabled:opacity-40"
          >
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div className="flex items-center justify-end gap-3">
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-xl bg-[#1a3a5c] px-3 py-2.5 text-sm font-bold text-white transition hover:bg-[#15304d] disabled:opacity-40"
              >
      ...
      <div className="mb-4 flex flex-wrap gap-3">
        <div className="relative min-w-[180px] flex-1">
          ...
          <input
            ...
            className="h-9 w-full rounded-xl border border-gray-200 pr-3 pl-8 text-sm transition focus:border-[#1a3a5c] focus:outline-none"
          />
          {search && (
            <button
              onClick={() => setSearch("")}
        ...
        <div className="relative">
          <select
            ...
            className="h-9 appearance-none rounded-xl border border-gray-200 bg-white pr-8 pl-3 text-sm text-gray-700 focus:border-[#1a3a5c] focus:outline-none"
          >
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100 bg-gray-50">
                ...
                <th className="px-3 py-3 text-right font-semibold whitespace-nowrap text-[#1a3a5c]">
                  PVP General
                </th>
                      ...
                      <div className="flex items-center gap-3">
                        {p.images[0] ? (
                          ...
                          <div
                            ...
                            style={{
                              backgroundColor: `${GAME_CONFIG[p.game]?.color ?? "#1a3a5c"}18`,
                            }}
                          >
                    ...
                    <td className="hidden px-4 py-3 sm:table-cell">
                      <div className="flex items-center justify-center gap-1">
                        <Link
                          ...
                          className="inline-flex items-center gap-1 rounded-lg border border-gray-200 px-2 py-1.5 text-xs font-semibold text-gray-500 transition hover:border-[#1a3a5c] hover:text-[#1a3a5c]"
                          title="Editar"
                        >
                          <Pencil size={11} />
                        </Link>
