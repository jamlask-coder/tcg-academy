      ...
      <div>
        <div className="mb-4 flex items-center justify-between">
          ...
          <button
            ...
            className="flex min-h-[40px] items-center gap-1.5 rounded-xl border border-gray-200 px-3 py-2 text-sm font-semibold text-gray-600 transition hover:border-[#1a3a5c] hover:text-[#1a3a5c]"
          >
