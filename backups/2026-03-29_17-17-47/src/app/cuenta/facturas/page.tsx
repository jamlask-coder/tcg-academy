      ...
      <div className="flex flex-wrap items-start justify-between gap-3 border-b border-gray-100 p-5">
        ...
        <div className="flex flex-shrink-0 items-center gap-3">
          ...
          <button
            ...
            className="flex min-h-[44px] items-center gap-1.5 rounded-lg px-3 py-2 text-sm font-semibold text-[#1a3a5c] transition hover:bg-blue-50"
          >
        ...
        <table className="w-full text-sm">
          ...
          <tfoot className="border-t-2 border-gray-200 bg-gray-50">
            ...
            <tr>
              ...
              <td
                colSpan={2}
                className="px-4 py-2.5 text-right text-base font-bold text-[#1a3a5c]"
              >
                {grandTotal.toFixed(2)}€
              </td>
            </tr>
        ...
        {isB2B && (
          <div className="flex flex-wrap items-center gap-2">
            <input
              ...
              className="h-10 rounded-xl border border-gray-200 px-3 text-sm text-gray-700 focus:border-[#1a3a5c] focus:outline-none"
            />
            <button
              onClick={() =>
                downloadPurchaseReport(filtered, reportPeriod || "completo")
              }
              className="flex min-h-[44px] items-center gap-1.5 rounded-xl bg-[#1a3a5c] px-4 py-2.5 text-sm font-bold text-white transition hover:bg-[#15304d]"
            >
      ...
      <div className="mb-5 flex flex-wrap gap-3">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="h-10 rounded-xl border border-gray-200 pr-3 pl-8 text-sm text-gray-700 focus:border-[#1a3a5c] focus:outline-none"
          />
        </div>
      </div>
