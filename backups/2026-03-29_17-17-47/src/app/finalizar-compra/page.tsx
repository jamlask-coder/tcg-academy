...
export default function CheckoutPage() {
    ...
    return (
      <div className="mx-auto max-w-[600px] px-6 py-24 text-center">
        ...
        <div className="flex flex-col justify-center gap-3 sm:flex-row">
          <Link
            href="/cuenta/pedidos"
            className="inline-block rounded-xl bg-[#1a3a5c] px-8 py-4 font-bold text-white transition hover:bg-[#15304d]"
          >
            Ver mis pedidos
          </Link>
          <Link
  ...
  return (
    <div className="mx-auto max-w-[1180px] px-6 py-8">
      <Link
        href="/carrito"
        className="mb-8 inline-flex items-center gap-1.5 text-sm text-gray-500 transition hover:text-[#1a3a5c]"
      >
      ...
      <div className="mb-10 flex items-center gap-2">
        {(["datos", "envio", "pago"] as Step[]).map((s, i) => (
          <div key={s} className="flex items-center gap-2">
            <div
              className={`flex h-8 w-8 items-center justify-center rounded-full text-sm font-bold transition ${step === s ? "bg-[#1a3a5c] text-white" : ["datos", "envio", "pago"].indexOf(step) > i ? "bg-green-500 text-white" : "bg-gray-200 text-gray-500"}`}
            >
          ...
          {step === "datos" && (
            <div className="space-y-4 rounded-2xl border border-gray-200 bg-white p-6">
              ...
              <button
                ...
                className="w-full rounded-xl bg-[#1a3a5c] py-4 font-bold text-white transition hover:bg-[#15304d]"
              >
                Continuar
              </button>
            </div>
          ...
          {step === "envio" && (
            <div className="space-y-4 rounded-2xl border border-gray-200 bg-white p-6">
              ...
              {[
                ...
                <label
                  key={opt.id}
                  className={`flex cursor-pointer items-center gap-4 rounded-xl border-2 p-4 transition ${form.envio === opt.id ? "border-[#1a3a5c] bg-blue-50/40" : "border-gray-200 hover:border-gray-300"}`}
                >
                  <input
                    type="radio"
                    name="envio"
              ...
              {isStorePickup && (
                <div className="space-y-2 rounded-xl border-2 border-[#1a3a5c]/20 bg-blue-50/30 p-4">
                  ...
                  {TIENDAS.map((t) => (
                    <label
                      key={t.id}
                      className={`flex cursor-pointer items-center gap-3 rounded-xl border-2 p-3 transition ${form.tiendaRecogida === t.id ? "border-[#1a3a5c] bg-white" : "border-gray-200 bg-white hover:border-gray-300"}`}
                    >
                      <input
                        type="radio"
                        name="tiendaRecogida"
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  className="flex-1 rounded-xl bg-[#1a3a5c] py-3.5 text-sm font-bold text-white transition hover:bg-[#15304d] disabled:cursor-not-allowed disabled:opacity-50"
                >
                  Continuar
                </button>
              </div>
          ...
          {step === "pago" && (
            <div className="space-y-4 rounded-2xl border border-gray-200 bg-white p-6">
              ...
              {[
                ...
                <label
                  key={opt.id}
                  className={`flex cursor-pointer items-center gap-4 rounded-xl border-2 p-4 transition ${form.pago === opt.id ? "border-[#1a3a5c] bg-blue-50/40" : "border-gray-200 hover:border-gray-300"}`}
                >
                  <input
                    type="radio"
                    name="pago"
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  onClick={handleOrder}
                  className="flex-1 rounded-xl bg-[#1a3a5c] py-3.5 text-sm font-bold text-white transition hover:bg-[#15304d]"
                >
