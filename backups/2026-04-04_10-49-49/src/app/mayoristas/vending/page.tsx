...
const PRODUCTS = [
  {
    cat: "Sobres sueltos",
    items: ["Magic", "Pokémon", "One Piece", "Yu-Gi-Oh!"],
  },
  {
    cat: "Blisters y packs",
    items: ["Pokémon ETB mini", "Lorcana starter", "DBS packs"],
  },
  {
    cat: "Accesorios",
    items: ["Sleeves surtidos", "Deck boxes", "Toploaders"],
  },
];
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#2e1065] to-[#7c3aed] py-20 text-white">
        ...
        <div className="relative mx-auto max-w-[1400px] px-6">
          ...
          <p className="max-w-2xl text-lg leading-relaxed text-purple-200">
            Lleva la experiencia TCG a centros comerciales, estaciones, colegios
            y más. 24 horas al día, 7 días a la semana. Sin personal, sin
            horarios.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[600px] px-6">
          ...
          >
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                <label className="mb-1 block text-sm font-semibold text-white">
                  Ubicación propuesta <span className="text-yellow-300">*</span>
                </label>
                <input
                  {...register("ubicacion")}
            ...
            >
              {isSubmitting ? "Enviando..." : "Registrar interés →"}
            </button>
          </form>
        </div>
      </section>
