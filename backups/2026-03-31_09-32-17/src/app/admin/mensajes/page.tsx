...
export default function AdminMensajesPage() {
  ...
  return (
    <div>
      {toast && (
        <div className="fixed right-6 bottom-6 z-50 flex items-center gap-2 rounded-2xl bg-[#1a3a5c] px-5 py-3 text-sm font-medium text-white shadow-xl">
          ...
          >
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-[#1a3a5c] py-2.5 text-sm font-bold text-white hover:bg-[#2d6a9f]"
              >
                <Send size={14} /> Enviar
              </button>
            </div>
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-xl bg-[#1a3a5c] px-4 py-2.5 text-sm font-bold text-white transition hover:bg-[#2d6a9f]"
          >
      ...
      <div className="mb-4 flex gap-2">
        {(
          ...
          <button
            ...
            className={`flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-semibold transition ${view === id ? "bg-[#1a3a5c] text-white" : "border border-gray-200 bg-white text-gray-600 hover:bg-gray-50"}`}
          >
            <Icon size={14} /> {label}
          </button>
        ))}
            ...
            <div className="space-y-2 border-b border-gray-100 p-3">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Buscar..."
                  maxLength={100}
                  className="w-full rounded-lg border border-gray-200 py-1.5 pr-3 pl-8 text-xs focus:border-[#1a3a5c] focus:outline-none"
                />
              </div>
              <div className="flex gap-1">
                {(
                  ...
                  <button
                    key={id}
                    onClick={() => setTab(id)}
                    className={`flex-1 rounded-lg py-1.5 text-xs font-semibold transition ${tab === id ? "bg-[#1a3a5c] text-white" : "text-gray-500 hover:bg-gray-100"}`}
                  >
                    {lbl}
                    {id === "inbox" && unread > 0 && (
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      className="h-10 w-full rounded-xl border border-gray-200 bg-white px-3 text-sm focus:border-[#1a3a5c] focus:outline-none"
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      maxLength={200}
                      className="h-10 w-full rounded-xl border border-gray-200 px-3 text-sm focus:border-[#1a3a5c] focus:outline-none"
                    />
                  </div>
                  <div>
                    <label className="mb-1 block text-xs font-semibold text-gray-500">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 rounded-xl bg-[#1a3a5c] px-4 py-2 text-sm font-bold text-white hover:bg-[#2d6a9f] disabled:opacity-50"
                    >
                      <Send size={14} /> Enviar
                    </button>
                  </div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {TARGET_OPTIONS.map((t) => (
                        <button
                          ...
                          className={`rounded-xl border-2 px-3 py-2.5 text-left text-xs font-semibold transition ${bcTarget === t.id ? "border-[#1a3a5c] bg-blue-50 text-[#1a3a5c]" : "border-gray-200 text-gray-600 hover:border-gray-300"}`}
                        >
                          {t.label}
                          ...
                          {filteredManualUsers.map((u) => (
                            ...
                            >
                              <input
                                ...
                                className="h-3.5 w-3.5 accent-[#1a3a5c]"
                              />
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {CHANNEL_OPTIONS.map((c) => (
                        <label
                          key={c.id}
                          className={`flex cursor-pointer items-center gap-3 rounded-xl border-2 p-3 transition ${bcChannel === c.id ? "border-[#1a3a5c] bg-blue-50" : "border-gray-200 hover:border-gray-300"}`}
                        >
                          <input
                            type="radio"
                            name="bcChannel"
