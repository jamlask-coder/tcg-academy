...
function GameLogo({
  ...
  if (errored) {
    return (
      <div
        className="h-6 px-2 rounded flex items-center justify-center text-white text-[9px] font-black tracking-tight whitespace-nowrap"
  ...
  return (
    ...
    <img
      ...
      width={68}
      height={24}
      className="h-6 w-auto object-contain max-w-[68px]"
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="flex items-center">
            ...
            {MEGA_MENU_DATA.map(({ slug, label, href, color, abbrev, logoSrc }) => {
              ...
              return (
                <div key={slug} onMouseEnter={() => openItem(slug)}>
                  <Link
                    href={href}
                    className="flex flex-col items-center gap-1 px-4 py-2 border-b-2 -mb-px transition-all"
                    style={{
                  ...
                  >
                    ...
                    <span
                      ...
                      style={{ color: active || open ? color : "#6b7280" }}
                    >
                      {label}
                    </span>
                  </Link>
