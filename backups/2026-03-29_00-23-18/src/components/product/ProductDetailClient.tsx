        ...
        {editing ? (
          <div className="flex items-center gap-1">
            <input
              ...
              className="w-24 border-2 border-[#1a3a5c] rounded-lg px-2 py-1 text-sm font-mono text-right focus:outline-none"
            />
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-2.5 p-3 bg-gray-50 rounded-xl text-sm">
            ...
            <span className="text-gray-600">
              Enviamos en menos de 24h con <strong>GLS</strong> — Envío gratis
              desde 149€
            </span>
          </div>
