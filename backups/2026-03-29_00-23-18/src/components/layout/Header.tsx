            ...
            {results.map((p) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span role="img" aria-label={p.game}>
                      {config?.emoji || "🃏"}
                    </span>
                  </div>
                  {/* Product info */}
...
const TRUST_MESSAGES = [
  { icon: Package, text: "Envío gratis desde 149€", highlight: "149€" },
  { icon: Clock, text: "Enviamos en menos de 24h", highlight: "24h" },
...
function MobileTrustBar() {
  ...
  return (
    <div
      className="lg:hidden text-white text-xs py-1.5 text-center px-4"
      style={{
        background:
...
export function Header() {
  ...
  return (
    <header className="bg-white border-b border-gray-200 shadow-sm">
      {/* Topbar — desktop */}
      <div
        className="text-white text-xs py-1.5 hidden lg:block"
        style={{
          background:
        ...
        <div className="max-w-[1400px] mx-auto px-6 flex items-center justify-between">
          <div className="flex items-center gap-0">
            <span className="flex items-center gap-1.5 font-medium">
              ...
              Envío gratis desde{" "}
              <strong className="text-amber-300 ml-1">149€</strong>
            </span>
            <span className="mx-4 border-l border-white/20 h-3" />
            <span className="flex items-center gap-1.5 font-medium">
              <Clock size={12} className="text-amber-300" />
              Enviamos en menos de{" "}
              <strong className="text-amber-300 ml-1">24h</strong>
            </span>
          </div>
          <div className="flex items-center gap-0">
            <span className="flex items-center gap-1.5 font-medium">
              <ShieldCheck size={12} className="text-amber-300" /> Pago{" "}
              <strong className="text-amber-300 ml-1">100% seguro</strong>
            </span>
            <span className="mx-4 border-l border-white/20 h-3" />
            <Link
              href="/tiendas"
      ...
      <div className="max-w-[1400px] mx-auto px-6 h-16 flex items-center gap-4">
        ...
        <div
          className="flex-1 max-w-xl hidden lg:block relative"
      ...
      {mobileSearchOpen && (
        <div
          className="px-4 pb-3 lg:hidden border-t border-gray-100"
          ref={mobileSearchRef}
        >
