    ...
    <div>
      ...
      <div className="flex items-center gap-3 mb-6">
        <Link
          ...
          className="p-2 hover:bg-gray-100 rounded-lg transition min-w-[40px] min-h-[40px] flex items-center justify-center"
        >
          <ArrowLeft size={18} />
        </Link>
        <div>
          ...
          {subtitle && (
            <p className="text-gray-500 text-sm mt-0.5 truncate max-w-md">
              {subtitle}
            </p>
          )}
        </div>
                ...
                {tags.length > 0 && (
                  <div className="flex flex-wrap gap-1.5">
                    {tags.map((tag) => (
                      <span
                        key={tag}
                        className="flex items-center gap-1 bg-blue-50 text-blue-700 px-2.5 py-1 rounded-full text-xs font-medium"
                      >
                        {tag}
                        <button
                          type="button"
              ...
              <div className="flex flex-wrap gap-6">
                <label className="flex items-center gap-3 cursor-pointer min-h-[44px]">
                  <input
                    type="checkbox"
                    {...register("inStock")}
                    className="w-5 h-5 rounded accent-[#1a3a5c]"
                  />
                ...
                {images.length > 0 && (
                  <div className="flex flex-wrap gap-2 mt-3">
                    {images.map((img, i) => (
                      <div
                        key={i}
                        className="relative flex items-center gap-2 bg-gray-100 rounded-lg px-3 py-2"
                      >
                        {i === 0 && (
            ...
            <div className="sticky top-36">
              ...
              <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden">
                ...
                <div className="px-3 pb-3">
                  <button
                    type="button"
                    className="w-full py-2.5 rounded-xl text-sm font-semibold flex items-center justify-center gap-2 bg-[#1a3a5c] text-white"
                  >
