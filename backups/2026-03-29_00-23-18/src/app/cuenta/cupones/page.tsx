      ...
      <div className="pl-6 pr-5 py-5">
        <div className="flex items-start justify-between gap-4 flex-wrap">
          ...
          >
            ...
            <div>
              <p
                className={`text-2xl font-black leading-none ${isActive ? "text-[#1a3a5c]" : "text-gray-400"}`}
              >
                {coupon.discountType === "percent"
                  ? `${coupon.value}%`
                  : `${coupon.value}€`}
        ...
        <div className="flex items-center justify-between mt-4 flex-wrap gap-2">
          ...
          >
            <span
              className={`font-mono font-bold tracking-wider text-sm ${isActive ? "text-[#1a3a5c]" : "text-gray-400"}`}
            >
              {coupon.code}
            </span>
            {isActive && (
          ...
          {/* Expiry */}
          <p
            className={`text-xs flex items-center gap-1 ${isActive ? "text-gray-500" : "text-gray-400"}`}
          >
            <Clock size={11} />
  ...
  return (
    <div>
      ...
      <div className="bg-gradient-to-br from-[#1a3a5c] to-[#2d6a9f] rounded-2xl p-6 mb-8 text-white">
        ...
        {redeemResult && (
          <div
            className={`mt-3 flex items-center gap-2 text-sm font-medium px-4 py-2.5 rounded-xl ${
              redeemResult.ok
