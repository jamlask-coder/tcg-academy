            ...
            return (
              ...
              >
                {productHref ? (
                  <Link
                    href={productHref}
                    className="relative w-20 h-20 flex-shrink-0 rounded-xl overflow-hidden bg-gray-50 border border-gray-100"
                  >
                    <Image
            ...
            <div className="space-y-2.5 mb-5">
              ...
              {shipping > 0 && (
                <p className="text-xs text-gray-400">
                  Te faltan <strong>{(149 - total).toFixed(2)}€</strong> para
                  envío gratis
                </p>
              )}
            </div>
            ...
            <div className="border-t border-gray-100 pt-4 mb-4">
              ...
              {appliedCoupon ? (
                <div className="flex items-center justify-between bg-green-50 border border-green-200 rounded-xl px-3 py-2.5">
                  ...
                  <button
                    onClick={removeCoupon}
                    className="text-gray-400 hover:text-red-400 transition ml-2 min-w-[32px] min-h-[32px] flex items-center justify-center"
                  >
                    <X size={14} />
                  </button>
                </div>
            ...
            <div className="border-t border-gray-100 pt-4 mb-5">
              ...
              {appliedPoints ? (
                <div className="flex items-center justify-between bg-amber-50 border border-amber-200 rounded-xl px-3 py-2.5">
                  ...
                  <button
                    onClick={removePoints}
                    className="text-gray-400 hover:text-red-400 transition min-w-[32px] min-h-[32px] flex items-center justify-center"
                  >
                    <X size={14} />
                  </button>
                </div>
