          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-100">
                ...
                <th className="text-right px-3 py-3 font-semibold text-[#1a3a5c] whitespace-nowrap">
                  PVP General
                </th>
                <th className="text-right px-3 py-3 font-semibold text-blue-600 whitespace-nowrap">
                  PVP Mayoristas
                </th>
                <th className="text-right px-3 py-3 font-semibold text-purple-600 whitespace-nowrap">
                  PVP Tiendas TCG
                </th>
                  ...
                  >
                    ...
                    <td className="px-3 py-3">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-medium text-gray-800 line-clamp-1 max-w-[280px]">
                          {p.name}
                        </span>
                      </div>
                    </td>
                        ...
                        {confirmDelete === p.id ? (
                          <div className="flex items-center gap-1">
                            <button
                              ...
                              className="text-xs font-bold text-white bg-red-500 px-2 py-1 rounded-lg"
                            >
                              Sí
                            </button>
                            <button
