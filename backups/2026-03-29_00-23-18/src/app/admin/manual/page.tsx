    ...
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
          <BookOpen size={22} className="text-[#1a3a5c]" /> Manual de
          administración
        </h1>
        ...
        <div className="lg:col-span-3 space-y-6">
          {SECTIONS.map(({ id, title, content }) => (
            <div
              key={id}
              id={id}
              className="bg-white border border-gray-200 rounded-2xl p-6 scroll-mt-36"
            >
              ...
              <div className="space-y-4">
                {content.map(({ heading, text }, i) => (
                  <div key={i}>
                    {heading && (
                      <h3 className="text-sm font-bold text-[#1a3a5c] mb-1">
                        {heading}
                      </h3>
                    )}
