      ...
      <form onSubmit={handleSubmit} className="flex items-stretch">
        ...
        >
          <input
            ...
            className={`h-full w-[118px] px-3 text-xs bg-gray-50 focus:bg-white focus:outline-none border-r transition-colors ${
  ...
  return (
    <header className="border-b border-gray-200 bg-white shadow-sm">
      ...
      <Container className="flex h-16 items-center justify-between gap-3">
        ...
        {/* ── LEFT: Logo + Search + Login (desktop) ─────────────────── */}
        <div className="flex min-w-0 items-center gap-3">
          ...
          {/* Desktop search — fixed width so login form fits beside it */}
          <div
            className="relative hidden w-[230px] flex-shrink-0 lg:block"
          ...
          {/* Desktop inline login / greeting (hidden on mobile) */}
          <HeaderInlineAuth />
        </div>
