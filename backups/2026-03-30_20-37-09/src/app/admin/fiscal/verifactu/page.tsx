      ...
      <div className="mb-6 rounded-2xl border border-gray-200 bg-white p-6">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <Shield size={20} className="text-[#1a3a5c]" />
            <div>
          ...
          <button
            ...
            className="flex h-9 items-center gap-2 rounded-lg bg-[#1a3a5c] px-4 text-sm font-semibold text-white transition hover:bg-[#15304d] disabled:opacity-60"
          >
      ...
      {chainLast5.length > 0 && (
        <div className="mb-6 rounded-2xl border border-gray-200 bg-white p-6">
          <div className="mb-4 flex items-center gap-2">
            <Link size={18} className="text-[#1a3a5c]" />
