      ...
      {addresses.length === 0 && !showForm && (
        <div className="rounded-2xl border border-gray-200 bg-white p-16 text-center">
          ...
          <button
            ...
            className="mt-4 text-sm font-semibold text-[#1a3a5c] hover:underline"
          >
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                <div className="mb-1 flex items-center gap-2">
                  ...
                  {addr.predeterminada && (
                    <span className="flex items-center gap-1 rounded-full bg-blue-50 px-2 py-0.5 text-[10px] font-bold text-[#1a3a5c]">
              ...
              <div className="flex flex-shrink-0 flex-col gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 text-xs text-gray-600 transition hover:text-[#1a3a5c]"
                >
