...
export const MEGA_MENU_DATA: MegaMenuGame[] = [
  ...
  },
  {
    ...
    color: "#0891b2",
    abbrev: "LOR",
    logoSrc: "/images/logos/lorcana.png",
    columns: [
      {
        title: "Producto Sellado",
        items: [
          { label: "Booster Boxes", href: "/lorcana/booster-box" },
          { label: "Sobres sueltos", href: "/lorcana/sobres" },
          { label: "Starter Decks", href: "/lorcana/starter" },
          { label: "Gift Sets", href: "/lorcana/gift-sets" },
          { label: "Trove Packs", href: "/lorcana/trove" },
        ],
      },
      {
        title: "Cartas y Accesorios",
        items: [
          { label: "Singles", href: "/lorcana/singles" },
          { label: "Cartas Enchanted", href: "/lorcana/enchanted" },
          { label: "Cartas promo", href: "/lorcana/promo" },
        ],
      },
    ],
  },
