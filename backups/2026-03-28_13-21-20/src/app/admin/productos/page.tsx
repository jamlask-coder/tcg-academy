...
import { Search, Save, X, ChevronDown, ChevronLeft, ChevronRight, Plus, Pencil } from "lucide-react"
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-100">
                ...
                <th className="text-center px-4 py-3 font-semibold text-gray-500 hidden sm:table-cell">Editar</th>
              </tr>
            </thead>
            <tbody>
              {paginated.map((p, i) => {
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-center hidden sm:table-cell">
                      <Link href={`/admin/productos/editar/${p.id}`}
                        className="inline-flex items-center gap-1 text-xs font-semibold text-gray-500 hover:text-[#1a3a5c] border border-gray-200 px-2.5 py-1.5 rounded-lg hover:border-[#1a3a5c] transition min-h-[32px]">
