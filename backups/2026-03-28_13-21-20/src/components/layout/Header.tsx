  ...
  return (
    <header className="bg-white border-b border-gray-200 shadow-sm">
      ...
      <div className="bg-[#1a3a5c] text-white text-xs py-1.5 hidden md:block">
        <div className="max-w-[1400px] mx-auto px-6 flex items-center justify-between">
          <div className="flex items-center gap-6 opacity-85">
            <span>Envío gratis en pedidos +149€</span>
      ...
      <div className="max-w-[1400px] mx-auto px-6 h-16 flex items-center gap-4">
        ...
        <div className="flex-1 max-w-xl hidden md:block relative" ref={desktopSearchRef}>
        ...
        <div className="flex items-center gap-1 ml-auto">
          ...
          <button
            ...
            className="p-2.5 rounded-lg hover:bg-gray-100 transition md:hidden min-w-[44px] min-h-[44px] flex items-center justify-center"
            aria-label="Buscar"
          >
      ...
      {/* Mobile search panel */}
      {mobileSearchOpen && (
        <div className="px-4 pb-3 md:hidden border-t border-gray-100" ref={mobileSearchRef}>
