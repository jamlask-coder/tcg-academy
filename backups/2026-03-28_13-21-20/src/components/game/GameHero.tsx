  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        />
        <div
          className="absolute -left-16 bottom-0 w-64 h-64 rounded-full blur-3xl opacity-10"
          style={{ backgroundColor: color }}
        />
      </div>

      <div className="relative max-w-[1180px] mx-auto px-6 py-12 lg:py-16">
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div>
            <motion.nav
              ...
              className="flex items-center gap-2 text-sm mb-6 opacity-70"
              style={{ color }}
            >
            ...
            >
              ...
              <img
                ...
                alt={name}
                className="h-14 md:h-20 w-auto max-w-[320px] object-contain"
                onError={(e) => {
              ...
              />
              <h1
                className="text-3xl md:text-5xl font-bold hidden"
                style={{ color }}
              >
                {name}
              </h1>
            ...
            <motion.p
              ...
              className="text-gray-600 max-w-md text-base md:text-lg leading-relaxed"
            >
              {description}
            </motion.p>
          </div>
          ...
          {/* Card fan animation */}
          {fanCards.length > 0 && (
            <div className="hidden lg:flex items-center justify-center h-52 relative">
              {fanCards.map((product, i) => {
                ...
                return (
                  <motion.div
                    key={product.id}
                    initial={{ opacity: 0, rotate: 0, x: 0, y: 30, scale: 0.85 }}
                    animate={{
                      opacity: 1,
                      rotate: cfg.rotate,
                      x: cfg.x,
                    ...
                    className="absolute w-24 h-32 rounded-xl shadow-xl overflow-hidden border-2 border-white/60 flex-shrink-0 cursor-pointer"
                  >
                    {cardImage ? (
                      // eslint-disable-next-line @next/next/no-img-element
                      <img
