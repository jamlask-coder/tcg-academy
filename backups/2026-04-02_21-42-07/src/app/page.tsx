...
export default function HomePage() {
  ...
  return (
    <div>
      {/* HERO */}
      <section className="relative flex min-h-[500px] w-full max-w-full items-center overflow-hidden bg-[#0f172a] text-white md:min-h-[580px]">
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1400px] px-4 py-16 sm:px-6 md:py-24">
          <div className="flex flex-col items-start gap-8 xl:flex-row xl:justify-between">
            ...
            <div className="hidden xl:flex flex-shrink-0 items-start justify-center" style={{ width: 500, marginLeft: -40 }}>
