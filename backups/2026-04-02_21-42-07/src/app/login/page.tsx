            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  maxLength={254}
                  className="h-11 w-full rounded-xl border-2 border-gray-200 pr-4 pl-10 text-sm transition-all focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/10 focus:outline-none"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  maxLength={128}
                  className="h-11 w-full rounded-xl border-2 border-gray-200 pr-10 pl-10 text-sm transition-all focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/10 focus:outline-none"
                />
                <button
                  type="button"
